...
public class Computer1DetailsActivity extends AppCompatActivity {

    private int itemQuantity = 0;
    private double price = 561.75;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer1_details);
        Log.i("Computer1Activity","now running onCreate");
    }

    @Override
    protected void onStart() {
        super.onStart();
        Log.i("Computer1Activity","now running onStart");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.i("Computer1Activity","now running onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.i("Computer1Activity","now running onPause");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.i("Computer1Activity","now running onStop");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Log.i("Computer1Activity","now running onRestart");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i("Computer1Activity","now running onDestroy");
    }
