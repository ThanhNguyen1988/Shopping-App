...
public class Phone1DetailsActivity extends AppCompatActivity {

    private int itemQuantity = 0;
    private double price = 3.04;
    private double totalAmount = 0.0;
    String colorItem="";
    String warningColor="";
    String warningQuantity="";
    boolean invalidPurchasing=false;
    CheckBox blueCheckBox,blackCheckBox,yellowCheckBox;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_phone1_details);
        Log.i("Phone1DetailsActivity","now running onCreate");
    }
    ...
    protected void onStart() {
        super.onStart();
        Log.i("Phone1DetailsActivity","now running onStart");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.i("Phone1DetailsActivity","now running onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.i("Phone1DetailsActivity","now running onPause");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.i("Phone1DetailsActivity","now running onStop");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Log.i("Phone1DetailsActivity","now running onRestart");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i("Phone1DetailsActivity","now running onDestroy");
    }
    ...
    public void onClickBuyNow(View view){
        ...
        if (invalidPurchasing==true){
            ...
            Toast.makeText(this,warningColor+warningQuantity ,Toast.LENGTH_LONG).show();
