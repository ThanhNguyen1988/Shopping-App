...
public class Beauty1DetailsActivity extends AppCompatActivity {

    private int itemQuantity = 0;
    private double price = 4.34;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beauty1_details);
        Log.i("Beauty1DetailsActivity","now running onCreate");
    }
    ...
    protected void onStart() {
        super.onStart();
        Log.i("Beauty1DetailsActivity","now running onStart");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.i("Beauty1DetailsActivity","now running onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.i("Beauty1DetailsActivity","now running onPause");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.i("Beauty1DetailsActivity","now running onStop");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Log.i("Beauty1DetailsActivity","now running onRestart");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i("Beauty1DetailsActivity","now running onDestroy");
    }
